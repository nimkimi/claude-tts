...
# ------------------------------------------------------------------ #
# Task 3.5 pins — all 29 MsgType keys present + negative guard        #
# ------------------------------------------------------------------ #
...
def test_all_29_msgtypes_registered():
    ...
    import sonari.daemon.registry as reg
    missing = [t for t in ALL_29 if t not in reg.HANDLERS]
